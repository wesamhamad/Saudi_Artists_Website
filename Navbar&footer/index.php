    ...
    <div class="container-fluid" style="font-family:'Noto Sans Arabic', sans-serif;">
      ...
      <div class="collapse navbar-collapse" id="navbarScroll">
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
          ...
          <a class="nav-link " href="Artists.html"  style="color:black;"> الـرسـامـيـن
              </a>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" style="color:black; transform: translate(15%, 10%);"> 
              </a>
          ...
          <!-- UNTIL HERE -->
          <div style="display:contents;">
          <a class="nav-link" href="#" data-bs-toggle="dropdown" style="color:black;"> المـعـارض
              </a>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" style="color:black; transform: translate(15%, 10%);">
              </a>
