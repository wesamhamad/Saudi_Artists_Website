  ...
  <div class="container-fluid" style="font-family:'Noto Sans Arabic', sans-serif;">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item">
           <span style="color:rgb(153, 93, 93);  margin-right: 10px; padding: 2px 4px ;  position:relative; bottom:-15%;">اهـلًا بـك&nbsp; <?php echo $login_session; ?></span>
          </li>

          <li class="nav-item">
          <a class="nav-link active " aria-current="page"  href="logout.php"> <button class="btn btn-outline "
                type="submit"
                style="border:1px solid lightgray; color:black;  margin-right: 10px; padding: 2px 4px ;  transform:translate(0%,-10%);">تــسجـيـل خــروج</button>
            </a>
          </li>
      </ul>
    </div>
...
<!-- end of navbar -->
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            ...
            <button type="button" class="btn" onclick="location.href = 'Artists.html'; "
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            ...
            <button type="button" class="btn" onclick="location.href = 'store.html'; "
              style=" position: relative; left:15%; bottom:5em;  background-color: lightgray; font-weight: bold;">الـمـتـجـر</button>
          </div>
        </div>
      </div>
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            ...
            <button type="button" class="btn" onclick="location.href = 'Activities.html'; "
  ...
  <!-- Footer section -->
  <footestyle=" font-family: 'Noto Sans Arabic', sans-serif"r>
    <div class="mt-4 pt-4 ">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
